package edu.unc.mapseq.messaging.gs.clean;
...
public class GSCleanMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(GSCleanMessageListener.class);

    public GSCleanMessageListener() {
        super();
    }
